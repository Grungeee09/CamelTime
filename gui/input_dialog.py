...
class InputDialog(ctk.CTk):
    def __init__(self, process_name: str, text: str = "Entry", title: str = "Input Dialog") -> None:
        super().__init__()

        ctk.set_appearance_mode("dark")

        self.answer = process_name
        ...
        self.cancel_button = ctk.CTkButton(self.buttons_frame, text="Cancel",
                                           width=100, command=lambda: self.get_answer("keep"))
    ...
    def get_answer(self, answer: str, with_destroy: bool = True) -> None:
        if answer == "ok":
...
def get_name(process_name: str, text: str = "Entry", title: str = "Input Dialog") -> str:
